...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="flygplatsp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e6d09709-e290-4d58-a6d1-963ae90834c4}">
      <rule filter=" &quot;genbeskr&quot; ='Flygbuller ekvivalentnivå'" key="{ebbc0be8-519a-4d57-bf6b-c908d5ab0484}" symbol="0" label="Flygplats - flygbuller ekvivalentnivå"/>
      <rule filter=" &quot;genbeskr&quot; ='Flygbuller maxnivå influensområde'" key="{d29fb8d0-244a-4908-86a4-c7a996765fdf}" symbol="1" label="Flygbuller maxnivå influensnivå"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="genbeskr" index="2" name=""/>
    <alias field="flygplatsp" index="3" name=""/>
    <alias field="layer" index="4" name=""/>
    <alias field="serial" index="5" name=""/>
    <alias field="tk_update" index="6" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="398572965">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="flygplatsp"/>
