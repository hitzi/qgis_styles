...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ea64704e-96ba-481d-a6d0-e34df3fc2aa5}">
      <rule filter="&quot;kkod&quot; = 12" key="{ee6bd35f-cfa4-43b3-be2a-d0cbf8c2a05e}" symbol="0" label="Sluten bebyggelse"/>
      <rule filter="&quot;kkod&quot; = 13" key="{82e2c1b0-622e-48f0-9774-3876b88949f5}" symbol="1" label="Hög bebyggelse"/>
      <rule filter="&quot;kkod&quot; = 14" key="{46ba62f6-3dfa-473f-bc5c-d993eb8565a1}" symbol="2" label="Låg bebyggelse"/>
      <rule filter="&quot;kkod&quot; = 15" key="{9b25fcf1-c991-434a-b71e-de2869a494d3}" symbol="3" label="Industriområde"/>
      <rule filter="&quot;kkod&quot; = 16" key="{82930a17-6ba2-4935-8428-e6f10450f22c}" symbol="4" label="Fritidsbebyggelse"/>
    </rules>
    <symbols>
