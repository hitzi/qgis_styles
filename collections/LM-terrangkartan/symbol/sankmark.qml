...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="100050" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{19365214-df98-42c7-b01e-1c341f579502}">
      <rule filter="&quot;kkod&quot; = 31" key="{341e89a7-b5dd-45c8-b6b1-d2ff3f9ff1d0}" symbol="0" label="Sankmark, svår"/>
      <rule filter="&quot;kkod&quot; = 32" key="{c6d7c957-e493-46c0-b744-80d7b84eefb9}" symbol="1" label="Sankmark, normal"/>
      <rule filter="&quot;kkod&quot; = 33" key="{0ad70500-78b9-4290-ac82-e5374a0ba701}" symbol="2" label="Berg i dagen"/>
      <rule filter="&quot;kkod&quot; = 35" key="{db84bfc4-ae71-4774-af57-e70c707f8186}" symbol="3" label="Torvtäkt"/>
      <rule filter="&quot;kkod&quot; = 37" key="{65dabb14-4b65-4bc6-8c13-ecebf62ddcbd}" symbol="4" label="Blekvät"/>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@1@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="235,153,0,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="0.7"/>
              <prop k="line_width_unit" v="Pixel"/>
              <prop k="offset" v="0"/>
