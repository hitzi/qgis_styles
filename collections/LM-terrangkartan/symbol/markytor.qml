...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{f697c3b7-bb07-4cd1-9ed3-8f0bd720491d}">
      <rule filter="&quot;KKOD&quot; = '1'" key="{524aef89-3ddd-46e5-9415-1a54c6d78df0}" symbol="0" label="Vattenyta"/>
      <rule filter="&quot;KKOD&quot; = '2'" key="{854a66aa-acd3-4ee2-bb12-b8a33037a99c}" symbol="1" label="Barr- och blandskog"/>
      <rule filter="&quot;KKOD&quot; = '4'" key="{3bd05455-c0de-47d9-b5aa-58ef0db5428e}" symbol="2" label="Åker"/>
      <rule filter="&quot;KKOD&quot; = '5'" key="{0a796498-4a0a-472b-9cde-67265985d7f8}" symbol="3" label="Annan öppen mark"/>
      <rule filter="&quot;KKOD&quot; = '7'" key="{dd79ebfc-d6f8-4ee8-a241-4455160bdfc5}" symbol="4" label="Fruktodling"/>
      <rule filter=" &quot;KKOD&quot; ='8'" key="{5e5eaa0b-88d1-44a7-b2a2-5e463082452c}" symbol="5" label="Kalfjäll"/>
      <rule filter="&quot;KKOD&quot; = '10'" key="{f52f3f20-439b-4083-bb99-0b554645498d}" symbol="6" label="Fjällbjörkskog"/>
      <rule filter=" &quot;KKOD&quot; ='12'" key="{c253ecb9-b814-4043-8127-fa280b858725}" symbol="7" label="Sluten bebyggelse"/>
      <rule filter=" &quot;KKOD&quot; ='14'" key="{4e3ef628-3858-4485-b09d-39deecd1e46b}" symbol="8" label="Låghusbebyggelse"/>
      <rule filter=" &quot;KKOD&quot; ='13'" key="{4c7dfe82-6f86-4b04-abf7-643a38b646b7}" symbol="9" label="Höghusbebyggelse"/>
      <rule filter="&quot;KKOD&quot; = '15'" key="{8449c60b-dd26-407e-a7d7-84401f4f24eb}" symbol="10" label="Industriområde"/>
      <rule filter="&quot;KKOD&quot; = 16" key="{9860f8d0-c4c1-4293-9e4a-82506fbc4ea9}" symbol="11" label="Fritidsbebyggelse"/>
      <rule filter="&quot;KKOD&quot; = '17'" key="{18987ceb-3d38-4c4a-bf45-8be4e7b04003}" symbol="12" label="Öppen mark utan skogskontur"/>
      <rule filter="&quot;KKOD&quot; = '18'" key="{bc4cee6d-fa26-46f8-b4f0-9a586d82a1fb}" symbol="13" label="Vattenyta med diffus strandlinje"/>
      <rule filter="&quot;KKOD&quot; = 19" key="{1236a25f-a3cb-45f3-8645-317a1956cab2}" symbol="14" label="Lövskog"/>
      <rule filter="&quot;KKOD&quot; = '20'" key="{1236a25f-a3cb-45f3-8645-317a1956cab2}" symbol="15" label="Ej karterat område"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="14">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="180,237,179,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="8">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="246,164,254,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <aliases>
    ...
    <alias field="_MATCHED_R" index="6" name=""/>
  </aliases>
