...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="50050" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{89295cf4-204a-4aab-a34c-4edf24104334}">
      <rule filter="&quot;kkod&quot; = 14" key="{a664b8d9-f20c-46bc-b254-7f40c801f1d4}" symbol="0" label="Fornlämningsavgränsning"/>
      <rule filter="&quot;kkod&quot; = 97" key="{e86ed204-0e2e-418c-b140-15a40b0d8d95}" symbol="1" label="Fornlämning, linjeformad"/>
      <rule filter="&quot;kkod&quot; = 694" key="{ffa04cb1-d7ee-4885-aff8-1d6b58c045ea}" symbol="2" label="Ruin, kantlinje"/>
      <rule filter="&quot;kkod&quot; = 695" key="{8e5789b4-32d6-4980-adfc-b8c5170155c4}" symbol="3" label="Ruin, mittlinje"/>
      <rule filter="&quot;kkod&quot; = 727" key="{afe17e5f-3c19-40f2-9db2-ca7b02754f4d}" symbol="4" label="Gruvhål, större"/>
    </rules>
    <symbols>
