...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{b6548922-d6b4-46ec-818c-cdd521a094ce}">
      <rule filter="&quot;KKOD&quot; = '5098'" key="{19f5e867-3294-46f8-8352-20f91236def8}" symbol="0" label="Cykelväg, parkväg"/>
      <rule filter="&quot;KKOD&quot; = '266'" key="{a83ad519-f74f-4e68-92e9-2da5b85d3b2d}" symbol="1" label="Elljusspår"/>
      <rule filter="&quot;KKOD&quot; = '335'" key="{cacce508-5474-4fca-9b3f-5da7c01a6745}" symbol="2" label="Farled"/>
      <rule filter="&quot;KKOD&quot; = '332'" key="{7d2e7517-e16b-4a03-bcab-2295d78780fd}" symbol="3" label="Gångbro"/>
      <rule filter="&quot;KKOD&quot; = '264'" key="{c7796810-64ce-4a20-a083-3e710c7aea51}" symbol="4" label="Gångstig"/>
      <rule filter="&quot;KKOD&quot; = '284'" key="{e42dcad3-4281-4d78-802a-8dccdb46bb03}" symbol="5" label="Linbana"/>
      <rule filter="&quot;KKOD&quot; = '5095'" key="{58c22ad3-bd07-44d9-8662-078ab5c21466}" symbol="6" label="Traktorväg"/>
      <rule filter="&quot;KKOD&quot; = '5899'" key="{cbfad56c-9d54-4340-a8a0-e47e8549a48e}" symbol="7" label="Underfart för övrig väg eller led"/>
      <rule filter="&quot;KKOD&quot; = '265'" key="{8d48f323-6eb1-4648-9d05-1538bfe7409c}" symbol="8" label="Vandringsled"/>
      <rule filter="&quot;KKOD&quot; = '268'" key="{63ade931-70c2-4739-bf31-0bbaa480326c}" symbol="9" label="Vandringsled, längs väg"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="6">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="4;1;4;0"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MapUnit"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="78,78,78,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.5102"/>
          <prop k="line_width_unit" v="Pixel"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="7">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="164,164,164,0"/>
          <prop k="line_style" v="solid"/>
