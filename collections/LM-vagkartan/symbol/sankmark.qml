...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{384203b0-3917-4efc-aa29-475f2e54027b}">
      <rule filter="&quot;kkod&quot; = '4'" key="{75ba35f8-6400-4f54-8dd4-d294c5857d86}" symbol="0" label="Sankmark, svårframkomlig (blåmyr)"/>
      <rule filter="&quot;kkod&quot; = '5'" key="{5be0343f-fb82-4f5d-9fed-0d0f6357d010}" symbol="1" label="Sankmark, normal, öppen (brunmyr)"/>
      <rule filter="&quot;kkod&quot; = '6'" key="{333d5821-9fa2-4715-bc57-786a2edfd310}" symbol="2" label="Sankmark, normal, skogklädd (brunmyr)"/>
      <rule filter="&quot;kkod&quot; = '13'" key="{6dcecde9-9c2b-4d92-828c-91f4ccc85796}" symbol="3" label="Sankmark, normal/svårframkomlig"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="146,186,248,255"/>
