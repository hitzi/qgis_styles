...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{0cda0729-f946-43ee-ad6d-0fdee633522d}">
      <rule filter="&quot;kkod&quot; = '21'" key="{87bf2483-3952-49b7-a0b8-135a622d3394}" symbol="0" label="Riksgräns"/>
      <rule filter="&quot;kkod&quot; = '22'" key="{b60dbd54-ab7e-49f3-be1f-dab0921bd094}" symbol="1" label="Territorialgräns"/>
      <rule filter="&quot;kkod&quot; = '23'" key="{70c819a0-cf15-4cd4-8f70-40e7fbce5cfc}" symbol="2" label="Länsgräns"/>
      <rule filter="&quot;kkod&quot; = '24'" key="{d7bb0f8c-9275-47d7-bd01-73e6a56208ff}" symbol="3" label="Kommungräns"/>
      <rule filter="&quot;kkod&quot; = '33'" key="{44ae1173-990a-4adb-b51c-176f642dcc98}" symbol="4" label="Traktgräns"/>
      <rule filter="&quot;kkod&quot; = '480'" key="{927bfc11-9bec-476b-9bb0-0bd008d6be4e}" symbol="5" label="Odlingsgräns, sammanfallande"/>
      <rule filter="&quot;kkod&quot; = '481'" key="{fa41ecd2-f313-4c4c-b3fc-2ffcbc703a53}" symbol="6" label="Odlingsgräns"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="2">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="0;2;1;2;1;2;3;0"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="0;1;1;1;1;1;3;0"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="0;1;1;1;3;0"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
