...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="100050" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{d9783e3a-3640-4962-a8bf-376b78cb87cb}">
      <rule filter="&quot;kkod&quot; = '75'" key="{bedb551e-6f27-446d-b9fc-ed22eddd03aa}" symbol="0" label="Anläggningsområde, streckad linje"/>
      <rule filter="&quot;kkod&quot; = '76'" key="{b6fa7760-541e-4060-8016-b18e63a7ac30}" symbol="1" label="Anläggningsområde, heldragen linje"/>
      <rule filter="&quot;kkod&quot; = '284'" key="{fbbebcfc-4645-4b6f-bbf1-589079be6a52}" symbol="2" label="Linbana"/>
      <rule filter="&quot;kkod&quot; = '329'" key="{fbbebcfc-4645-4b6f-bbf1-589079be6a52}" symbol="3" label="Viadukt"/>
      <rule filter="&quot;kkod&quot; = '337'" key="{fbbebcfc-4645-4b6f-bbf1-589079be6a52}" symbol="4" label="Dammbyggnad, större, kantlinje"/>
      <rule filter="&quot;kkod&quot; = '391'" key="{0f2c74d1-ff14-4b17-bed5-dbff14966d8e}" symbol="5" label="Renstängsel"/>
      <rule filter="&quot;kkod&quot; = '695'" key="{a2f645d0-a2c6-4873-8766-58a178e4e35d}" symbol="6" label="Ruin, mittlinje"/>
      <rule filter="&quot;kkod&quot; = '9920'" key="{3205f73e-817d-4430-95d4-1500455c2b0f}" symbol="7" label="Rengärde"/>
    </rules>
    <symbols>
