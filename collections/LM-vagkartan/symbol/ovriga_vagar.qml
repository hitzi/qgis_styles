...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="100050" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{7ca62151-707d-43be-bd56-dc667a4fb8a5}">
      <rule filter="&quot;kkod&quot; = '254'" key="{5a618778-6837-4984-b284-833fa5d192cf}" symbol="0" label="Cykelled"/>
      <rule filter="&quot;kkod&quot; = '259'" key="{a72fe6dd-04c5-4233-b1b0-3f05a6739017}" symbol="1" label="Skoterled"/>
      <rule filter="&quot;kkod&quot; = '264'" key="{05d40b04-d9b8-4389-a6c4-45b32bbfa3db}" symbol="2" label="Gångstig"/>
      <rule filter="&quot;kkod&quot; = '265'" key="{20a5f42a-161a-4e70-861c-b0399e23497e}" symbol="3" label="Vandringsled"/>
      <rule filter="&quot;kkod&quot; = '268'" key="{e6f4efd3-14ad-4ee8-9820-25c19002dc09}" symbol="4" label="Vandringsled, längs väg"/>
      <rule filter="&quot;kkod&quot; = '289'" key="{fa6e5a9e-fdac-4447-9ff1-2ad030666c0d}" symbol="5" label="Annan led"/>
      <rule filter="&quot;kkod&quot; = '332'" key="{3281ecad-7456-42b0-af03-646859496e06}" symbol="6" label="Gångbro"/>
      <rule filter="&quot;kkod&quot; = '335'" key="{a0d2d776-8a8b-4ebb-8519-be5b6f6c45f0}" symbol="7" label="Farled"/>
      <rule filter="&quot;kkod&quot; = '336'" key="{a0d2d776-8a8b-4ebb-8519-be5b6f6c45f0}" symbol="8" label="Färjeled"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="122,160,85,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="7">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="0,106,208,255"/>
          <prop k="line_style" v="dash"/>
          <prop k="line_width" v="0.5"/>
          <prop k="line_width_unit" v="Pixel"/>
          <prop k="offset" v="0"/>
