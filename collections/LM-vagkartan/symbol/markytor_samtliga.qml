...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{384203b0-3917-4efc-aa29-475f2e54027b}">
      <rule filter="&quot;kkod&quot; = '1'" key="{9b467448-a77a-490e-b36c-a949dc712269}" symbol="0" label="Vatten"/>
      <rule filter="&quot;kkod&quot; = '2'" key="{fca01ef5-1fb9-4233-bc09-fb6593765343}" symbol="1" label="Bebyggelseområde"/>
      <rule filter="&quot;kkod&quot; = '3'" key="{3bfd125f-9b62-42f2-bc99-dfbee35a3b82}" symbol="2" label="Skog"/>
      <rule filter="&quot;kkod&quot; = '4'" key="{75ba35f8-6400-4f54-8dd4-d294c5857d86}" symbol="3" label="Sankmark, svårframkomlig (blåmyr)"/>
      <rule filter="&quot;kkod&quot; = '5'" key="{5be0343f-fb82-4f5d-9fed-0d0f6357d010}" symbol="4" label="Sankmark, normal, öppen (brunmyr)"/>
      <rule filter="&quot;kkod&quot; = '6'" key="{333d5821-9fa2-4715-bc57-786a2edfd310}" symbol="5" label="Sankmark, normal, skogklädd (brunmyr)"/>
      <rule filter="&quot;kkod&quot; = '7'" key="{bef8e36b-e28f-4ae3-8571-f6be71913a62}" symbol="6" label="Öppen mark"/>
      <rule filter="&quot;kkod&quot; = '8'" key="{bef8e36b-e28f-4ae3-8571-f6be71913a62}" symbol="7" label="Kalfjäll/fjällhed"/>
      <rule filter="&quot;kkod&quot; = '10'" key="{bef8e36b-e28f-4ae3-8571-f6be71913a62}" symbol="8" label="Fjällbjörkskog"/>
      <rule filter="&quot;kkod&quot; = '11'" key="{12b34b6d-5839-4a8a-b591-dc744655d05c}" symbol="9" label="Glaciär"/>
      <rule filter="&quot;kkod&quot; = '13'" key="{6dcecde9-9c2b-4d92-828c-91f4ccc85796}" symbol="10" label="Sankmark, normal/svårframkomlig"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="174,193,217,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="10">
        <layer pass="0" class="LinePatternFill" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="253,244,227,255"/>
          <prop k="distance" v="8.2346"/>
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@10@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="146,186,248,255"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@4@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="225,172,0,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="1"/>
              <prop k="line_width_unit" v="Pixel"/>
              <prop k="offset" v="0"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@5@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="255,172,0,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="1"/>
              <prop k="line_width_unit" v="Pixel"/>
              <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="6">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="251,241,162,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="7">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="253,247,193,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="8">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="254,251,224,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
