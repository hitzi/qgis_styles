...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="KNAMN">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="OMKRETS_M">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="LANSKOD" index="1" name=""/>
    <alias field="THEMES" index="2" name=""/>
    <alias field="ANM" index="3" name=""/>
    <alias field="TK_UPDATE" index="4" name=""/>
    <alias field="TILLKDATUM" index="5" name=""/>
    <alias field="METODBESKR" index="6" name=""/>
    <alias field="ORIGINALID" index="7" name=""/>
    <alias field="AREA_M2" index="8" name=""/>
    <alias field="REVDATUM" index="9" name=""/>
    <alias field="KNAMN" index="10" name=""/>
    <alias field="SERIAL" index="11" name=""/>
    <alias field="NAMN" index="12" name=""/>
    <alias field="BESKRIVNIN" index="13" name=""/>
    <alias field="REFERENS" index="14" name=""/>
    <alias field="OMKRETS_M" index="15" name=""/>
    <alias field="OUTPUT" index="16" name=""/>
    <alias field="OBJEKTLANK" index="17" name=""/>
    <alias field="_MATCHED_R" index="18" name=""/>
    <alias field="AREA_HA" index="19" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="KNAMN"/>
      ...
      <column width="-1" hidden="0" type="field" name="OMKRETS_M"/>
