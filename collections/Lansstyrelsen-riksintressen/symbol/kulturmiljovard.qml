...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="METODBESKR" index="5" name=""/>
    <alias field="ORIGINALID" index="6" name=""/>
    <alias field="AREA_M2" index="7" name=""/>
    <alias field="REVDATUM" index="8" name=""/>
    <alias field="SERIAL" index="9" name=""/>
    <alias field="NAMN" index="10" name=""/>
    <alias field="BESKRIVNIN" index="11" name=""/>
    <alias field="REFERENS" index="12" name=""/>
    <alias field="OMKRETS_M" index="13" name=""/>
    <alias field="OUTPUT" index="14" name=""/>
    <alias field="OBJEKTLANK" index="15" name=""/>
    <alias field="_MATCHED_R" index="16" name=""/>
  </aliases>
